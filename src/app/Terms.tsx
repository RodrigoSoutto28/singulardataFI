...
export default function Terms() {
  ...
  const c = {
    ES: {
      ...
      body: [
        ['1. Aceptación', 'Al usar SINGULAR dataFI aceptás estos términos. Si no estás de acuerdo, no utilices la plataforma.'],
        ['2. Naturaleza del servicio', 'SINGULAR dataFI es una herramienta de análisis y registro de operaciones. No ofrece asesoramiento financiero, ni señales, ni promesas de rentabilidad. El usuario es el único responsable de sus decisiones de inversión.'],
        ...
        ['5. Limitación de responsabilidad', 'SINGULAR dataFI no se responsabiliza por pérdidas financieras derivadas del uso de la plataforma. El servicio se ofrece "tal cual" sin garantías.'],
        ...
        ['7. Contacto', 'Para consultas: hello@singulardatafi.com'],
      ],
    },
    EN: {
      ...
      body: [
        ['1. Acceptance', 'By using SINGULAR dataFI you agree to these terms. If you do not agree, do not use the platform.'],
        ['2. Nature of service', 'SINGULAR dataFI is an analytics and journaling tool. It does not provide financial advice, signals, or profit guarantees. The user is solely responsible for their investment decisions.'],
        ...
        ['5. Limitation of liability', 'SINGULAR dataFI is not liable for financial losses derived from the use of the platform. The service is provided "as is" without warranties.'],
        ['6. Changes', 'We may update these terms. Updates are posted in the app and on this page.'],
        ['7. Contact', 'For inquiries: hello@singulardatafi.com'],
      ],
    },
    PT: {
      ...
      body: [
        ['1. Aceitação', 'Ao usar o SINGULAR dataFI você aceita estes termos. Se não concorda, não utilize a plataforma.'],
        ['2. Natureza do serviço', 'SINGULAR dataFI é uma ferramenta de análise e diário. Não oferece assessoria financeira, sinais ou garantias de lucro. O usuário é o único responsável pelas suas decisões.'],
        ...
        ['5. Limitação de responsabilidade', 'SINGULAR dataFI não se responsabiliza por perdas financeiras. O serviço é fornecido "como está" sem garantias.'],
        ['6. Alterações', 'Podemos atualizar estes termos. As alterações são publicadas no app e nesta página.'],
        ['7. Contato', 'Consultas: hello@singulardatafi.com'],
      ],
    },
  }[language];
