...
export default function Terms() {
  ...
  const c = {
    ES: {
      ...
      body: [
        ['1. Aceptación', 'Al usar Mind On aceptás estos términos. Si no estás de acuerdo, no utilices la plataforma.'],
        ['2. Naturaleza del servicio', 'Mind On es una herramienta de análisis y registro de operaciones. No ofrece asesoramiento financiero, ni señales, ni promesas de rentabilidad. El usuario es el único responsable de sus decisiones de inversión.'],
        ...
        ['5. Limitación de responsabilidad', 'Mind On no se responsabiliza por pérdidas financieras derivadas del uso de la plataforma. El servicio se ofrece "tal cual" sin garantías.'],
    ...
    EN: {
      ...
      body: [
        ['1. Acceptance', 'By using Mind On you agree to these terms. If you do not agree, do not use the platform.'],
        ['2. Nature of service', 'Mind On is an analytics and journaling tool. It does not provide financial advice, signals, or profit guarantees. The user is solely responsible for their investment decisions.'],
        ...
        ['5. Limitation of liability', 'Mind On is not liable for financial losses derived from the use of the platform. The service is provided "as is" without warranties.'],
    ...
    PT: {
      ...
      body: [
        ['1. Aceitação', 'Ao usar o Mind On você aceita estes termos. Se não concorda, não utilize a plataforma.'],
