...
const baseTranslations: Record<Language, Translations> = {
  ES: {
    ...
    auth: {
      ...
      welcomeToApp: '¡Bienvenido a MindOn!',
      headline: 'Opera más inteligente con insights',
      headlineHighlight: 'potenciados por IA',
      subheadline: 'Únete a miles de traders que usan MindOn para rastrear, analizar y mejorar su rendimiento.',
      features: {
  ...
  EN: {
    ...
    auth: {
      ...
      welcomeToApp: 'Welcome to MindOn!',
      headline: 'Trade smarter with',
      headlineHighlight: 'AI-powered insights',
      subheadline: 'Join thousands of traders using MindOn to track, analyze and improve their performance.',
      features: {
  ...
  PT: {
    ...
    auth: {
      ...
      welcomeToApp: 'Bem-vindo ao MindOn!',
      headline: 'Opere com mais inteligência usando insights',
      headlineHighlight: 'alimentados por IA',
      subheadline: 'Junte-se a milhares de traders que usam MindOn para rastrear, analisar e melhorar seu desempenho.',
      features: {
